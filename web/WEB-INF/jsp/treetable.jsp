        ...
        <div class="container" id="wrap">
            ...
            <div clas="navigationPanel">
                <nav class="navbar navbar-default">
                    ...
                    <h3>Таблица деревьев</h3>   
            <div class="row" >
                <div class="col-md-1 col-md-offset-2" id="tablehead"> id </div>
                <div class="col-md-1 " id="tablehead"> название</div>
                <div class="col-md-1 " id="tablehead"> описание</div>
                <div class="col-md-1 " id="tablehead"> гумус </div>
                <div class="col-md-1 " id="tablehead"> нитриты </div>
                <div class="col-md-1 " id="tablehead"> фосфор </div>
            </div>  
            <%
                for (int i =0; i<5;i++) {          
            %>        
