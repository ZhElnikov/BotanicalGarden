        ...
        <div class="container" id="wrap">
            ...
            <div clas="navigationPanel">
                <nav class="navbar navbar-default">
                    ...
                    <h3>Таблица заказа удобрений</h3>   
            <div class="row" >
                ...
                <div class="col-md-1 " id="tablehead"> кол-во </div>
                <div class="col-md-3 " id="tablehead"> объяснение </div>
                <div class="col-md-1 " id="tablehead"> статус </div>
            </div>  
            <%
                for (int i =0; i<5;i++) {          
            %>        
