        ...
        <div class="container" id="wrap">
            ...
            <div clas="navigationPanel">
                <nav class="navbar navbar-default">
                    ...
                    <h3>Таблица отчетов</h3>   
            <div class="row" >
                <div class="col-md-1 col-md-offset-2" id="tablehead"> id </div>
                <div class="col-md-1 " id="tablehead"> #пользователя </div>
                <div class="col-md-1 " id="tablehead"> код </div>
                <div class="col-md-3 " id="tablehead"> сообщение </div>                       
            </div>  
            <%
                for (int i =0; i<5;i++) {          
            %>        
