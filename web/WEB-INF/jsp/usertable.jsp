    ...
    <body>
        <div class="container" id="wrap">
            ...
            <div class="row" >
                ...
                <div class="col-md-1 " id="tablehead"> роль </div>
                <div class="col-md-1 " id="tablehead"> логин </div>
                <div class="col-md-1 " id="tablehead"> пароль </div>
                <div class="col-md-1 " id="tablehead"> e-mail </div>
                <div class="col-md-1 " id="tablehead"> дата регистрации </div>                          
            </div>  
            <%
                for (int i =0; i<5;i++) {          
            %>        
