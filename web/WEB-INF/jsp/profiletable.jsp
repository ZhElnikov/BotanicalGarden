        ...
        <div class="container" id="wrap">
            ...
            <div clas="navigationPanel">
                <nav class="navbar navbar-default">
                    ...
                    <h3>Таблица профилей</h3>   
            <div class="row" >
                <div class="col-md-1 col-md-offset-2" id="tablehead"> id </div>
                <div class="col-md-1 " id="tablehead"> имя </div>
                <div class="col-md-1 " id="tablehead"> фамилия </div>
                <div class="col-md-1 " id="tablehead"> профессия </div>
                <div class="col-md-2 " id="tablehead"> характеристика </div>                        
            </div>  
            <%
                for (int i =0; i<5;i++) {          
            %>        
            <div class="row">
                ...
                <div class="col-md-1 col-md-offset-2"> <input type="text" th:value="" id="" name="" class="tableInput"> </div>
                <div class="col-md-1 "> <input type="text" th:value="" id="" name="" class="tableInput"> </div>
                <div class="col-md-1 "> <input type="text" th:value="" id="" name="" class="tableInput"> </div>
                <div class="col-md-1 "> <input type="text" th:value="" id="" name="" class="tableInput"> </div>
                <div class="col-md-2 "> <input type="text" th:value="" id="" name="" class="tableInput-large"> </div>
