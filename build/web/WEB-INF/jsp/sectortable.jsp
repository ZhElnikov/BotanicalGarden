        ...
        <div class="container" id="wrap">
            ...
            <div clas="navigationPanel">
                <nav class="navbar navbar-default">
                    ...
                    <h3>Таблица секторов</h3>   
            <div class="row" >
                <div class="col-md-1 col-md-offset-3" id="tablehead"> id </div>
                <div class="col-md-1 " id="tablehead"> площадь</div>
                <div class="col-md-1 " id="tablehead"> дерево </div>
                <div class="col-md-1 " id="tablehead"> почва </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1 col-md-offset-3"> <input type="text" th:value="" id="" name="" class="tableInput"> </div>
